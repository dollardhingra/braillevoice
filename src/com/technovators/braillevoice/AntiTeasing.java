...
public class AntiTeasing extends ListActivity implements TextToSpeech.OnInitListener{
	TextToSpeech tts;
	String classes[]={"back","Anti Eve Teasing Helpline\n011-27894455","Anti-Teasing Cell \n1096"}; 
	ListView lv;
	Vibrator vb;
	Boolean vibration;
	Boolean tts_engine;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setListAdapter(new ArrayAdapter<String>(AntiTeasing.this, android.R.layout.simple_list_item_1, classes)); 
...
if (selec.equals("back")) {
			...
			/*try{
				...
				Intent ourIntent = new Intent(AntiTeasing.this, ourClass);
				vb.vibrate(400);
...
*/
	...
	public void onInit(int arg0) {
		...
		tts.speak("Anti Teasing sub menu",	TextToSpeech.QUEUE_FLUSH, null);
	}
